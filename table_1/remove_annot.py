...
if __name__ == "__main__":
    ...
    parser.add_argument('--src_directory', type=str, default='/home/nima/Desktop/nullability-docker/table_1/versions/nullaway', help='The source directory to process.')
