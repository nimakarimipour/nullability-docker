...
public class CacheMetadataCorruptedException extends Exception {
    ...
    CacheMetadataCorruptedException(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Throwable cause) {
        super(cause);
    }
