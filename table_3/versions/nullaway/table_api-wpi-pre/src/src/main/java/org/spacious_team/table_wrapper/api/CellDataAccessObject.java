...
public interface CellDataAccessObject<C, R extends ReportPageRow> {
    ...
    C getCell(R row, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.Nullable Integer cellIndex);
