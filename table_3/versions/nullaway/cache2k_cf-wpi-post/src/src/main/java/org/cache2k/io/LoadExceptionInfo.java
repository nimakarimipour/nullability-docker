...
public interface LoadExceptionInfo<K, V> extends CacheEntry<K, V> {
     ...
     */
    @org.checkerframework.dataflow.qual.Pure
    default V getValue(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull LoadExceptionInfo<K, V> this) {
     ...
     */
    @org.checkerframework.dataflow.qual.Pure
    default @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull LoadExceptionInfo<K, V> getExceptionInfo(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull LoadExceptionInfo<K, V> this) {
        return this;
    }
     ...
     */
    @org.checkerframework.dataflow.qual.Pure
    default @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull RuntimeException generateExceptionToPropagate() {
