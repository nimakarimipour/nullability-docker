...
public class Expiry implements ExpiryTimeValues {
    ...
    public static  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long toSharpTime(long millis) {
        if (millis == ETERNAL) {
            return ETERNAL;
        }
        if (millis < 0) {
     ...
     */
    @org.checkerframework.dataflow.qual.Pure
    public static  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long earliestTime(long loadTime, long candidate1, long candidate2) {
     ...
     */
    @org.checkerframework.dataflow.qual.Pure
    public static  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long mixTimeSpanAndPointInTime(long loadTime, long refreshAfter, long pointInTime) {
