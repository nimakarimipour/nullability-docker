...
public class UiUtils {
     ...
     */
    public static Bitmap getBitmapFromDrawable(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.Nullable Drawable drawable) {
        if (drawable == null) {
            return null;
        } else {
            Bitmap bitmap;
     ...
     */
    public static Drawable getDrawableFromBitmap(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Bitmap bitmap) {
        if (bitmap == null) {
            return null;
        } else {
