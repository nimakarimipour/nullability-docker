...
public class FilteredUserListBuilder {
    ...
    public <T> @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull FilteredUserListBuilder withFilter(final UserFilter<T> filter, final T value) {
        if (filters == null) {
            filters = new HashMap<>();
        }
