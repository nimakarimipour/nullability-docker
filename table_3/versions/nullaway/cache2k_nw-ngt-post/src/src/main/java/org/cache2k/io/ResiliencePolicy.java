...
public interface ResiliencePolicy<K, V> extends ExpiryTimeValues, Customization<K, V> {
    ...
    ResiliencePolicy<?, ?> DISABLED_POLICY = new ResiliencePolicy<Object, Object>() {
        ...
        @Override
        public long suppressExceptionUntil(@javax.annotation.Nullable Object key, @javax.annotation.Nullable LoadExceptionInfo<Object> loadExceptionInfo, @javax.annotation.Nullable CacheEntry<Object, Object> cachedEntry) {
            return NOW;
        }

        @Override
        public long retryLoadAfter(@javax.annotation.Nullable Object key, @javax.annotation.Nullable LoadExceptionInfo<Object> loadExceptionInfo) {
            return NOW;
        }
    };
     ...
     */
    long suppressExceptionUntil(@javax.annotation.Nullable K key, @javax.annotation.Nullable LoadExceptionInfo<K> loadExceptionInfo, @javax.annotation.Nullable CacheEntry<K, V> cachedEntry);
     ...
     */
    long retryLoadAfter(@javax.annotation.Nullable K key, @javax.annotation.Nullable LoadExceptionInfo<K> loadExceptionInfo);
}
