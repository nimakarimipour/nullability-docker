...
public interface ResiliencePolicy<K, V> extends ExpiryTimeValues, Customization<K, V> {
     ...
     */
    @org.checkerframework.dataflow.qual.Pure
     @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long suppressExceptionUntil(K key, LoadExceptionInfo<K> loadExceptionInfo, CacheEntry<K, V> cachedEntry);
     ...
     */
    @org.checkerframework.dataflow.qual.Pure
     @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long retryLoadAfter(K key, LoadExceptionInfo<K> loadExceptionInfo);
}
