...
public class SectionContainer extends AbstractCollection<ConfigSection> implements Collection<ConfigSection>, Serializable {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    public <T extends ConfigSection> @org.checkerframework.checker.nullness.qual.Nullable T getSection(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Class<T> sectionType, @org.checkerframework.checker.nullness.qual.Nullable T defaultFallback) {
