...
public interface Cache<K, V> extends KeyValueStore<K, V>, Closeable {
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    <R> R invoke(K key, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull EntryProcessor<K, V, R> entryProcessor);
