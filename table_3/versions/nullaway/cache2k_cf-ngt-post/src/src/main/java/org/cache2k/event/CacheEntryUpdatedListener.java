...
public interface CacheEntryUpdatedListener<K, V> extends CacheEntryOperationListener<K, V> {
     ...
     */
    void onEntryUpdated(@javax.annotation.Nullable Cache<K, V> cache, @javax.annotation.Nullable CacheEntry<K, V> currentEntry, @javax.annotation.Nullable CacheEntry<K, V> newEntry);
}
