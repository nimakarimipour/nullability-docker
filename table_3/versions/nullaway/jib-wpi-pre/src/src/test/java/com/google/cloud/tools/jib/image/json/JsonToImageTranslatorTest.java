...
public class JsonToImageTranslatorTest {
    ...
    @org.checkerframework.dataflow.qual.Impure
    private <T extends BuildableManifestTemplate> void testToImage_buildable(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull String jsonFilename, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Class<T> manifestTemplateClass) throws IOException, LayerPropertyNotFoundException, LayerCountMismatchException, DigestException, URISyntaxException {
