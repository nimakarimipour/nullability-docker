...
for source in ["wpi", "annotator", "nullgtn"]:
    ...
    results_folder = f"checkers/nullaway/{source}"
    ...
    for benchmark in os.listdir(benchmarks_folder):
        ...
        src = open(f'../../NJR/original/{benchmark}/info/sources', "r").readlines()
        ...
        lib_folder = f'../../NJR/original/{benchmark}/lib:{ERRORPRONE_DIR}/nullaway-annotations-0.10.22.jar:{ERRORPRONE_DIR}/jsr305-3.0.1.jar:{CHECKER_DIR}/checker/dist/checker-qual.jar'
