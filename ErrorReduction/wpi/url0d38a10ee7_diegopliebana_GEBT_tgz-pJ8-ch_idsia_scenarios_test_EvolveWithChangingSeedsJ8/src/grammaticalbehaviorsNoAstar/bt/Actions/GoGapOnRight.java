...
public class GoGapOnRight extends BTLeafNode {
     ...
     @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull int m_stepsInObjective;

     @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull int m_nopTime;

    private final  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull int MAX_OBJ_STEPS = 15;

    @org.checkerframework.dataflow.qual.SideEffectFree
    public GoGapOnRight(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTNode a_parent) {
        super(a_parent);
    ...
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull GoGapOnRight this) throws IncorrectNodeException {
        super.step();
        //Get the agent
        ...
        if (marioPos == objective) {
            ...
            boolean obsUp = mario.isObstacle(GEBT_MarioAgent.MARIO_X - 3, GEBT_MarioAgent.MARIO_X - 1, aheadStartPos, aheadEndPos);
            if (obsUp) {
        ...
        if (thereIsGap || (objective != -1)) {
            ...
            boolean needJumpAhead = mario.isEnemy(GEBT_MarioAgent.MARIO_X - 1, GEBT_MarioAgent.MARIO_X, aheadStartPos, aheadEndPos);
            ...
            boolean needJumpBack = mario.isEnemy(GEBT_MarioAgent.MARIO_X - 1, GEBT_MarioAgent.MARIO_X, aheadStartPos, aheadEndPos);
            ...
            if (marioPos > objective) {
                ...
                if (needJumpAhead || needJumpBack) {
                    ...
                    if (m_stepsInObjective == MAX_OBJ_STEPS) {
                        ...
                        aheadEndPos = GEBT_MarioAgent.MARIO_Y + 1;
                        boolean obsAhead = mario.isObstacle(GEBT_MarioAgent.MARIO_X - 3, GEBT_MarioAgent.MARIO_X - 2, aheadStartPos, aheadEndPos);
