...
public class EnemyAheadUp extends BTLeafNode {
    ...
    public EnemyAheadUp(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTNode a_parent) {
        super(a_parent);
    }

    @org.checkerframework.dataflow.qual.Impure
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull EnemyAheadUp this) throws IncorrectNodeException {
        super.step();
        //Get the agent
        ...
        boolean enemyAhead = mario.isEnemy(GEBT_MarioAgent.MARIO_X - 5, GEBT_MarioAgent.MARIO_X - 1, aheadStartPos, aheadEndPos);
        if (enemyAhead)
