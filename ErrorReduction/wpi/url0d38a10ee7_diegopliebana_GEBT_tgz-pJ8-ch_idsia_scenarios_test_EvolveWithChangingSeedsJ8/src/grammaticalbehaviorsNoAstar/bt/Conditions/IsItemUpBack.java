...
public class IsItemUpBack extends BTLeafNode {
    ...
    public IsItemUpBack(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTNode a_parent) {
        super(a_parent);
    }

    @org.checkerframework.dataflow.qual.Impure
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull IsItemUpBack this) throws IncorrectNodeException {
        super.step();
        //Get the agent
        ...
        boolean itUp = mario.isItem(GEBT_MarioAgent.MARIO_X - 8, GEBT_MarioAgent.MARIO_X - 1, aheadStartPos, aheadEndPos);
        if (itUp) {
