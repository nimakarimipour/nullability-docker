...
public class NoJumpableEnemyAhead extends BTLeafNode {
    ...
    public NoJumpableEnemyAhead(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTNode a_parent) {
        super(a_parent);
    }

    @org.checkerframework.dataflow.qual.Impure
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull NoJumpableEnemyAhead this) throws IncorrectNodeException {
        super.step();
        //Get the agent
        ...
        boolean enemyAhead = mario.isNoJumpableEnemy(GEBT_MarioAgent.MARIO_X - 1, GEBT_MarioAgent.MARIO_X, aheadStartPos, aheadEndPos);
        if (enemyAhead)
