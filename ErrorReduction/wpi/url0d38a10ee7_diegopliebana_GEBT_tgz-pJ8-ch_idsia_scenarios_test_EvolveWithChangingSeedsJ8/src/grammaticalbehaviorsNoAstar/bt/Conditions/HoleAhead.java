...
public class HoleAhead extends BTLeafNode {
    ...
    public HoleAhead(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTNode a_parent) {
        super(a_parent);
    }

    @org.checkerframework.dataflow.qual.Impure
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull HoleAhead this) throws IncorrectNodeException {
        super.step();
        //Get the agent
        ...
        */
        ...
        if (groundUnderMario) {
            ...
            boolean holeAhead = !mario.isObstacle(GEBT_MarioAgent.MARIO_X + 1, GEBT_MarioAgent.MARIO_X + 1, aheadStartPos, aheadEndPos);
            if (holeAhead)
