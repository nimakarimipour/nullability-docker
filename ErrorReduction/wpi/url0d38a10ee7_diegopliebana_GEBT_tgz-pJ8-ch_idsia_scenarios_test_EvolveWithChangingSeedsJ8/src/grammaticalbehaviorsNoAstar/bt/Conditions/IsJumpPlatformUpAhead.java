...
public class IsJumpPlatformUpAhead extends BTLeafNode {
    ...
    public IsJumpPlatformUpAhead(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTNode a_parent) {
        super(a_parent);
    }

    @org.checkerframework.dataflow.qual.Impure
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull IsJumpPlatformUpAhead this) throws IncorrectNodeException {
        super.step();
        //Get the agent
