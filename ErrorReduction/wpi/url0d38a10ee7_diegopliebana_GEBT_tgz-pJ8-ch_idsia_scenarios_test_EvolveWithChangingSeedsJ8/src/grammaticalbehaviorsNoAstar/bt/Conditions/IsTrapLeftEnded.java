...
public class IsTrapLeftEnded extends BTLeafNode {
    ...
    public IsTrapLeftEnded(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTNode a_parent) {
        super(a_parent);
        m_detectedTrapPos = -1;
    }

    @org.checkerframework.dataflow.qual.Impure
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull IsTrapLeftEnded this) throws IncorrectNodeException {
        super.step();
        //Get the agent
