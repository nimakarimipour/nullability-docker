...
public class GetPathToClosestQuestion extends BTLeafNode {
    ...
    public void resetNode(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull GetPathToClosestQuestion this) {
        m_forbidden = new Vector<Integer>();
    }

    @org.checkerframework.dataflow.qual.Impure
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull GetPathToClosestQuestion this) throws IncorrectNodeException {
        super.step();
