...
public class BTUntilFailsLimitedFilter extends BTNode {
    ...
    public void resetNode(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTUntilFailsLimitedFilter this) {
        m_numExecutions = 0;
    }
