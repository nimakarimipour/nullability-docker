...
public class BTParallelNode extends BTNode {
    ...
    private  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull int m_nodesToFail;

    private  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull int m_nodesToSucceed;

    private  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull int m_curNodesFailed;

    private  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull int m_curNodesSucceeded;

    @org.checkerframework.dataflow.qual.SideEffectFree
    BTParallelNode(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTNode a_parentNode) {
        super(a_parentNode);
        m_nodesToFail = 1;
        m_nodesToSucceed = 1;
        m_curNodesFailed = 0;
    ...
    public void resetNode(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTParallelNode this) {
        m_nodesToFail = 1;
        m_nodesToSucceed = 1;
        m_curNodesFailed = 0;
        m_curNodesSucceeded = 0;
    ...
    @org.checkerframework.dataflow.qual.Impure
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BTParallelNode this) throws IncorrectNodeException {
        super.step();
        m_nodeStatus = BTConstants.NODE_STATUS_EXECUTING;
        if (m_nodeCount < 2)
