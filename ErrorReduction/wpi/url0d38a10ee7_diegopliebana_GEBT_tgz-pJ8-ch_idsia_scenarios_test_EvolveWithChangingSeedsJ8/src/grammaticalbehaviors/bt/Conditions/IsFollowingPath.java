...
public class IsFollowingPath extends BTLeafNode {
    ...
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull IsFollowingPath this) throws IncorrectNodeException {
        super.step();
        //Get the agent
