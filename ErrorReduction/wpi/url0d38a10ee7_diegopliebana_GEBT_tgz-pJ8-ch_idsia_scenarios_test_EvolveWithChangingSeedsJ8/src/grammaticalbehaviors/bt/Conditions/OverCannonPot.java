...
public class OverCannonPot extends BTLeafNode {
    ...
    public void step(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull OverCannonPot this) throws IncorrectNodeException {
        super.step();
        ...
        if (marioNodeId != -1) {
            ...
            if (Map.isPotOrCannon((byte) marioNode.getMetadata())) //if(marioNode.getMetadata() == Map.MAP_POT_OR_CANNON)
            {
