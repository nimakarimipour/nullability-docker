...
public class BasicTask implements Task {
    ...
    // stands for  FPS 24, prescribed FPS.
    private long COMPUTATION_TIME_BOUND = 42;

    public BasicTask(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull CmdLineOptions cmdLineOptions) {
        if (environment == null) {
    ...
    public void reset(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull CmdLineOptions cmdLineOptions) {
