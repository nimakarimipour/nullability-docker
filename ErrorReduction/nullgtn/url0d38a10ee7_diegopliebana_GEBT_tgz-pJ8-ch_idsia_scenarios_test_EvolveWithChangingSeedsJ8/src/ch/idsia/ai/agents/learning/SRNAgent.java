...
public class SRNAgent implements Agent, Evolvable {
    ...
    public boolean[] getAction(Environment observation) {
        double[] inputs = new double[] { probe(-1, -1, levelScene), probe(0, -1, levelScene), probe(1, -1, levelScene), probe(-1, 0, levelScene), probe(0, 0, levelScene), probe(1, 0, levelScene), probe(-1, 1, levelScene), probe(0, 1, levelScene), probe(1, 1, levelScene), probe(-1, -1, enemies), probe(0, -1, enemies), probe(1, -1, enemies), probe(-1, 0, enemies), probe(0, 0, enemies), probe(1, 0, enemies), probe(-1, 1, enemies), probe(0, 1, enemies), probe(1, 1, enemies), observation.isMarioOnGround() ? 1 : 0, observation.isMarioAbleToJump() ? 1 : 0, 1 };
