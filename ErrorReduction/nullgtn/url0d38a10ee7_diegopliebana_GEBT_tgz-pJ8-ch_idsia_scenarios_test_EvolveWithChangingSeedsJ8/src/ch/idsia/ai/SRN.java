...
public class SRN implements FA<double[], double[]>, Evolvable {
    ...
    public SRN(double[][] firstConnectionLayer, double[][] recurrentConnectionLayer, double[][] secondConnectionLayer, int numberOfHidden, int numberOfOutputs) {
    ...
    public SRN copy() {
        return new SRN(copy(firstConnectionLayer), copy(recurrentConnectionLayer), copy(secondConnectionLayer), hiddenNeurons.length, outputs.length);
    }
