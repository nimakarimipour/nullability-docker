...
public interface Environment {
    ...
    public void reset(@javax.annotation.Nullable int[] setUpOptions);
    ...
    public byte[][] getMergedObservationZZ(@javax.annotation.Nullable int ZLevelScene, @javax.annotation.Nullable int ZLevelEnemies);

    public byte[][] getLevelSceneObservationZ(@javax.annotation.Nullable int ZLevelScene);

    public byte[][] getEnemiesObservationZ(@javax.annotation.Nullable int ZLevelEnemies);
    ...
    void performAction(@javax.annotation.Nullable boolean[] action);
    ...
    void reset(@javax.annotation.Nullable CmdLineOptions cmdLineOptions);

    void setAgent(@javax.annotation.Nullable Agent agent);
}
