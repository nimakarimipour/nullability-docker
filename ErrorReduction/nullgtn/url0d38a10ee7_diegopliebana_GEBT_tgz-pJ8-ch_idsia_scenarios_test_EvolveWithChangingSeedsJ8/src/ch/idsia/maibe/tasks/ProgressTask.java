...
public final class ProgressTask extends BasicTask implements Task {
    ...
    private float evaluateSingleLevel(@javax.annotation.Nullable int ld, @javax.annotation.Nullable int tl, @javax.annotation.Nullable int ls, @javax.annotation.Nullable boolean vis, Agent controller) {
        this.totalEpisodes++;
