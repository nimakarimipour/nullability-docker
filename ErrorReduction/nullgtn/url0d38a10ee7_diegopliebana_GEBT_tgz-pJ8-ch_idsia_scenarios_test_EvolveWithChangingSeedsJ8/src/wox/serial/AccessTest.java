...
public class AccessTest {
    ...
    public static void main(@javax.annotation.Nullable String[] args) throws Exception {
    ...
    private static Constructor getConstructor(Class cl) throws Exception {
        Method getCons = ObjectStreamClass.class.getDeclaredMethod("getSerializableConstructor", new Class[] { Class.class });
