...
public class FollowCurrentPath extends BTLeafNode {
    ...
    private boolean manageJump(GEBT_MarioAgent mario, Node a_marioNode, Node a_destNode, Edge a_edge) {
    ...
    private boolean verticalJump(GEBT_MarioAgent mario, Node a_marioNode, Node a_destNode) {
        int marioInertia = mario.getInertia();
        float marioSpeedX = mario.getMarioSpeedX();
        if (m_startingEdge) {
            //1.a PRECALCULATION OF THE JUMP
