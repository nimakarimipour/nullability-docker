...
public class Node {
    ...
    public Vector<Long> getEdgesFromNode() {
        return m_edges;
    }
    ...
    public void setEnemies(Vector<Enemy> a_enemies) {
        m_enemies = a_enemies;
    }
    ...
    public void setItems(Vector<Item> a_items) {
        m_items = a_items;
    }
