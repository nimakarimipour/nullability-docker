...
public class EvoMain {
    ...
    private float m_totalItemsCollected;
    ...
    private float score(CmdLineOptions cmdLineOptions, int[] timeLimits, int[] levelDifficulties, int[] levelTypes, int[] levelLengths, boolean[] creaturesEnables) {
