...
public class Graph {
    ...
    public static final int MODE_BREAKABLE = 6;
    ...
    private HashMap<Integer, Path> getShortestPaths(int a_origin) {
        return m_shortestPaths.get(a_origin);
    }

    private HashMap<Integer, HashMap<Integer, Path>> getShortestPaths() {
