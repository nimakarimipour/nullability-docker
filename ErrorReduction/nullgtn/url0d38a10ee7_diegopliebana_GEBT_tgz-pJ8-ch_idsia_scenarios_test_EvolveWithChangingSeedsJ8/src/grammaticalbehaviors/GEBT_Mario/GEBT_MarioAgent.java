...
public class GEBT_MarioAgent implements Agent {
    ...
    public static final int MARIO_X = 11;

    //Environment.HalfObsWidth;  //10;
    public static final int MARIO_Y = 11;
    ...
    public Vector<IntPair> getForbiddenGaps() {
    ...
    public MoveSimulator getMoveSimulator() {
        return m_moveSim;
    }
    ...
    public void followingNewPath(boolean a_new) {
        m_followingNewPath = a_new;
    }

    public void setFollowingPath(boolean a_follow) {
    ...
    public Hashtable<Integer, Integer> getRecord() {
        return m_record;
    }

    public Vector<Integer> getGaps() {
        return m_gaps;
    }
    ...
    public void setOnRightMostFlag(@javax.annotation.Nullable boolean a_flag) {
    ...
    public void setCurrentPathIndex(int a_newIndex) {
...
*/
    ...
    public void integrateObservation(int[] serializedLevelSceneObservationZ, int[] serializedEnemiesObservationZ, @javax.annotation.Nullable float[] marioFloatPos, @javax.annotation.Nullable float[] enemiesFloatPos, @javax.annotation.Nullable int[] marioState) {
    }
