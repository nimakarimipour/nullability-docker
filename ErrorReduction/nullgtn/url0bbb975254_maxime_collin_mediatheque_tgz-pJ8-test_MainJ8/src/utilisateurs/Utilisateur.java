...
public abstract class Utilisateur {
    ...
    protected abstract int eligibilite(@javax.annotation.Nullable medias.Media media);

    public abstract int commenter(@javax.annotation.Nullable int idEmprunt, @javax.annotation.Nullable int n, @javax.annotation.Nullable String com);
