...
public class ControleurEmprunt {
    ...
    public Boolean emprunter(int idUser, int idMedia, @javax.annotation.Nullable Date de, @javax.annotation.Nullable Date dr) {
    ...
    public Boolean emprunter(int idUser, int idMedia, @javax.annotation.Nullable Date de, @javax.annotation.Nullable Date dr, int nbJours) {
        Utilisateur user = controleurUser.getUtilisateur(idUser);
        if (user == null)
            return false;
        // on recupere l'index du media
