...
public class Main {
    ...
    public static void main(String[] args) {
        FakePersistantCustomer[] persistantCustomers = { new FakePersistantCustomer("101", "Cust 101", FakePersistantCustomerType.Basic, "NoDisc"), new FakePersistantCustomer("102", "Cust 102", FakePersistantCustomerType.Preferred, "Preferred5pct") };
        FakePersistantProduct[] persistantProducts = { new FakePersistantProduct("Prod001", "Product 001", "Shoes", 15.00, "Buy3_5Dlrs"), new FakePersistantProduct("Prod002", "Product 002", "Shoes", 15.00, "15PctOff") };
        FakePersistantDiscount[] persistantDiscounts = { new FakePersistantDiscount("NoDisc", FakePersistantDiscountType.None, "No Discount", 0, 0.0), new FakePersistantDiscount("Buy3_5Dlrs", FakePersistantDiscountType.ByQuantity, "Buy 3 or More Save $5.00", 3, 5.0), new FakePersistantDiscount("15PctOff", FakePersistantDiscountType.ByPercentage, "15% Discount", 0, 15.0), new FakePersistantDiscount("Preferred5pct", FakePersistantDiscountType.ByPercentage, "Preferred Customer 15% Discount", 0, 5.0) };
