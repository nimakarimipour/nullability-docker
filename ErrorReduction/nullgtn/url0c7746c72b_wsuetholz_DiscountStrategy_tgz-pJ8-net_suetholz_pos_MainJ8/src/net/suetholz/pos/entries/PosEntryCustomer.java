...
public class PosEntryCustomer implements PosEntryStrategy {
    ...
    @Override
    public final void processEntry(@javax.annotation.Nullable StoreStrategy store, SaleStrategy sale, @javax.annotation.Nullable SaleOutputStrategy receiptOutput) {
        if (sale == null) {
            throw new IllegalArgumentException();
        }
